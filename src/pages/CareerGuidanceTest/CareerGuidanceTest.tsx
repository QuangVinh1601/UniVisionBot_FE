      ...
      {isTestStarted && (
        <>
          ...
          <div className="p-4">
            ...
            <div className="flex items-center mb-2">
              <label className="mr-2 whitespace-nowrap w-1/3">Bạn đang học lớp nào <span className="text-red-500">*</span></label>
              <input
                type="text"
            ...
            <div className="flex items-center mb-2">
              <label className="mr-2 whitespace-nowrap w-1/3">Bạn đang học ở trường nào <span className="text-red-500">*</span></label>
              <input
                type="text"
          ...
          <p className="text-red-500 font-bold bg-gray-200 p-4">
            Các ý liệt kê trong mỗi bảng hướng đến các tố chất và năng lực của bạn. 
            Với mỗi ý sẽ có nhiều mức độ phù hợp với bạn, tương ứng với mức độ phù hợp, sẽ được quy định một điểm
            số tương ứng.  Điểm số tương ứng này do bạn đánh giá và tự điền vào bảng theo thang đo sau.<br/><br/>
